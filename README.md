...
Файл располагается в корневой папке EASY (см. [структуру проекта](#file_folder-структура-проекта)).  
...
Файл создается в корневой директории проекта (см. [структуру проекта](#file_folder-структура-проекта))  
...
Управление окнами, переключение между ними и прочие действия выполняются при помощи [горячих клавиш](#color6f73d2largetextbf2-управление-tmux)
...
Список знаков: см. [приложение](#color6f73d2largetextbf1-спец-символы).
...
Загружает файлы из папки 'uploader/' на сервер (см. [структуру проекта](#file_folder-структура-проекта))
...
### $\color{#6F73D2}\large{\textbf{2) Управление tmux}}$
<details>
...
### $\color{#6F73D2}\large{\textbf{n) Настройка EASY на WSL}}$
