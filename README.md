...
Файл создается в корневой директории проекта (см. [структуру проекта](#-структура-проекта))  
...
Список знаков: см. [приложение](#1-спец-символы).
...
### $\color{#6F73D2}\large{\textbf{2) Настройка EASY на WSL}}$
