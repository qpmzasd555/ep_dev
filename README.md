...
`Навигация`                        `Стрелки (ANSI escape sequences)`

| Обозначение | Код  | Описание  | | Обозначение | Код    | Описание       |
| ----------- | ---- | --------- | | ----------- | ------ | -------------- |
| enter       | \r   | Enter     | | up          | \x1b[A | Стрелка вверх  |
| tab         | \t   | Tab       | | down        | \x1b[B | Стрелка вниз   |
| backspace   | \x08 | Backspace | | right       | \x1b[C | Стрелка вправо |
| space       |      | Пробел    | | left        | \x1b[D | Стрелка влево  |
